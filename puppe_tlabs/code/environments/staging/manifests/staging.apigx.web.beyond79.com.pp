...
#
node /staging\.apigx\.web[0-9]+\.beyond79\.com/ {
    ...
    # repos
       ...
       # end repos
        ...
        nginx::resource::vhost { 'secure.apigx.com':
            server_name => ['staging.secure.apigx.com'],
            ...
            ssl => true,
            ssl_cert => '/etc/pki/tls/certs/apigx.cer',
            ssl_key => '/etc/pki/tls/certs/apigx.key',
            listen_port => 80,
       ...
       nginx::resource::location { "apigx-php":
            ensure          => present,
            vhost           => "apigx.com",
            www_root        => "/var/www/apigx/public/",
            location        => '~ \.php$',
