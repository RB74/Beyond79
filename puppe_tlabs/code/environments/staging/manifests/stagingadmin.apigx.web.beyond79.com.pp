...
#
node /stagingadmin\.apigx\.web[0-9]+\.beyond79\.com/ {
    ...
    # repos
       ...
       # end repos
        ...
        # goldexchange resources symlinks
       ...
       nginx::resource::vhost { 'admin.apigx.com':
           server_name => ['stagingadmin.apigx.com'],
  ...
  file { '/etc/profile':
    ...
    source => 'puppet:///files/environment-variables/staging.goldexchange.txt',
  }

  file { '/etc/crontab':
    ensure => present,
    source => 'puppet:///files/cron/staging.goldexchange.txt',
  }
